...
import { authenticate } from '../fn/user-controller/authenticate';
import { Authenticate$Params } from '../fn/user-controller/authenticate';
import { AuthenticateResponse } from '../models/authenticate-response';
import { confirm } from '../fn/user-controller/confirm';
import { Confirm$Params } from '../fn/user-controller/confirm';
...
export class UserControllerService extends BaseService {
  ...
  static readonly AuthenticatePath = '/User/authenticate';
  ...
  static readonly ConfirmPath = '/User/activate-account';
